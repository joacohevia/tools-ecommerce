...
user-invocable: false #en false funciona como contexto/instrucciones auxiliares que el sistema puede  proporcionar al agente cuando detecta que son relevantes, pero no se expone como una herramienta invocable directamente.
