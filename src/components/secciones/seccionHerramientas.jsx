...
const SeccionHerramientas = () => {
  ...
  return (
    <section className="relative w-full min-h-[400px] md:min-h-[500px] overflow-hidden group my-8">
      <div
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 py-10 text-center">
        ...
        <p className="font-body text-body-lg text-white/80 max-w-xl mb-6 md:mb-8">
